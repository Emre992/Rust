...
- **/role** - Setup a specific role to use IGNClanBot.
...
- **/uptime** - Get the current uptime for IGNClanBot.
- **/voice** - Let IGNClanBot join voicechat.
...
- **recycle** - Display the output of recycling an item.
- **research** - Display the cost to research an item.
- **send** - Send a message through IGNClanBot to a person on Discord.
...
- **unmute** - Unmute IGNClanBot In-Game.
- **upkeep** - Check upkeep of Storage Monitor Tool Cupboards.
- **uptime** - Display the uptime of IGNClanBot and currently connected server.
...
- Easily access IGNClanBot settings via the Discord Text-Channel `settings`.
