...
[**/role**](commands.md#role) | Set/Clear a specific role that will be able to see the IGNClanBot category content.
...
> **Set/Clear a specific role that will be able to see the IGNClanBot category content.**

Subcommand | Options | Description | Required
---------- | ------- | ----------- | --------
`set` | &nbsp; | Set the role. | &nbsp;
&nbsp; | `role` | The role IGNClanBot channels will be visible to. | `True`
`clear` | &nbsp; | Clear the role (to allow everyone to see the IGNClanBot channels). | &nbsp;
